    ...
    try:
        ...
        with open('book_data.csv', 'a', newline="") as wf:
            ...
            if os.stat('book_data.csv').st_size == 0:
                ...
                '''By default, pandas interprets numeric columns in the CSV as numeric data types, and leading zeros in integers are ignored. This behavior is consistent with how integers are usually handled in programming languages like Python.
                To preserve leading zeros in the ISBN numbers, you need to explicitly specify that the "isbn" column should be treated as a string (object) data type during the CSV read operation. You can do this by setting the dtype parameter of pd.read_csv()'''
